...
@CrossOrigin(origins = "*")
public class LocationGroupController extends GroupingNovelItemController<LocationGroup, Location> {
    @Autowired
    private LocationGroupService parentService;

    @Override
    protected GroupingNovelItemService<LocationGroup, Location> getService() {
