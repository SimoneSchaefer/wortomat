...
@CrossOrigin(origins = "*")
public class ResearchGroupController extends GroupingNovelItemController<ResearchGroup, Research> {
    @Autowired
    private ResearchGroupService parentService;

    @Override
    protected GroupingNovelItemService<ResearchGroup, Research> getService() {
